...
func newImage(db *gorm.DB, opts ...gen.DOOption) image {
	...
	_image.imageDo.UseModel(&mysql.Image{})

	tableName := _image.imageDo.TableName()
	_image.ALL = field.NewAsterisk(tableName)
	_image.ID = field.NewString(tableName, "id")
	_image.UserID = field.NewString(tableName, "user_id")
	_image.URL = field.NewString(tableName, "url")
	_image.OriginalFilename = field.NewString(tableName, "original_filename")
	_image.Filepath = field.NewString(tableName, "filepath")
	_image.Filesize = field.NewInt64(tableName, "filesize")
	_image.MimeType = field.NewString(tableName, "mime_type")
...
func (i *image) updateTableName(table string) *image {
	...
	i.OriginalFilename = field.NewString(table, "original_filename")
	i.Filepath = field.NewString(table, "filepath")
	i.Filesize = field.NewInt64(table, "filesize")
...
func (i *image) fillFieldMap() {
	...
	i.fieldMap["original_filename"] = i.OriginalFilename
	i.fieldMap["filepath"] = i.Filepath
	i.fieldMap["filesize"] = i.Filesize
...
type IImageDo interface {
	...
	Unscoped() IImageDo
	Create(values ...*mysql.Image) error
	CreateInBatches(values []*mysql.Image, batchSize int) error
	Save(values ...*mysql.Image) error
	First() (*mysql.Image, error)
	Take() (*mysql.Image, error)
	Last() (*mysql.Image, error)
	Find() ([]*mysql.Image, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*mysql.Image, err error)
	FindInBatches(result *[]*mysql.Image, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*mysql.Image) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*mysql.Image, error)
	FirstOrCreate() (*mysql.Image, error)
	FindByPage(offset int, limit int) (result []*mysql.Image, count int64, err error)
...
func (i imageDo) Create(values ...*mysql.Image) error {
	if len(values) == 0 {
		return nil
	}
...
func (i imageDo) CreateInBatches(values []*mysql.Image, batchSize int) error {
	return i.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (i imageDo) Save(values ...*mysql.Image) error {
	if len(values) == 0 {
		return nil
	}
...
func (i imageDo) First() (*mysql.Image, error) {
	if result, err := i.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*mysql.Image), nil
	}
}

func (i imageDo) Take() (*mysql.Image, error) {
...
func (i imageDo) Last() (*mysql.Image, error) {
...
func (i imageDo) Find() ([]*mysql.Image, error) {
	result, err := i.DO.Find()
	return result.([]*mysql.Image), err
}

func (i imageDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*mysql.Image, err error) {
	buf := make([]*mysql.Image, 0, batchSize)
...
func (i imageDo) FindInBatches(result *[]*mysql.Image, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (i imageDo) FirstOrInit() (*mysql.Image, error) {
...
func (i imageDo) FirstOrCreate() (*mysql.Image, error) {
...
func (i imageDo) FindByPage(offset int, limit int) (result []*mysql.Image, count int64, err error) {
...
func (i imageDo) Delete(models ...*mysql.Image) (result gen.ResultInfo, err error) {
